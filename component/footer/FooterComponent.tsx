...
export default function FooterComponent() {
  ...
  return (
    <footer className="px-3 pt-4 lg:px-9 border-t-2 bg-gray-50 ">
      <div className="grid gap-24 row-gap-6  sm:grid-cols-2 lg:grid-cols-4  ">
        <div className="sm:col-span-2 ">
          <a href="#" className="inline-flex items-center">
            <Image src="https://mcqmate.com/public/images/logos/60x60.png" width={60} height={60} alt="Company Logo" className="h-8 w-8" />
        ...
        <div>
          ...
          <div className="flex items-center gap-1 px-2">
            <a href="#" className="w-full min-w-xl">
              <Image src="/images/icons/playstore.svg" width={100} height={40} alt="Playstore Button" />
            </a>
            <a className="w-full min-w-xl" href="https://www.youtube.com/channel/UCo8tEi6SrGFP8XG9O0ljFgA">
              <Image src="/images/icons/youtube.svg" width={100} height={40} alt="Youtube Button" className="h-28" />
            </a>
          </div>
